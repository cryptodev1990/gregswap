    ...
    <div className="flex justify-center py-24">
      <div className="flex flex-col items-center gap-10 bg-app-dark-swap border-1 border-app-dark rounded-xl w-96 py-4 px-5">
        <input
          ...
          placeholder="1"
        />
        <button className="bg-app-dark-button px-8 py-2 sm:w-1/2 w-full rounded-full text-app-dark-button text-lg font-bold active:text-blue-600 active:bg-blue-500">Sign</button>
      </div>
    </div>
  );
};
